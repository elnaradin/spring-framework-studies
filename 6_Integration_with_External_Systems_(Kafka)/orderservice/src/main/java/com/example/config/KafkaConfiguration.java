...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, OrderEvent> orderEventProducerFactoryeventProducerFactory(ObjectMapper objectMapper) {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderStatusEvent> orderStatusEventConcurrentKafkaListenerContainerFactory(ConsumerFactory<String, OrderStatusEvent> orderStatusEventConsumerFactory) {
